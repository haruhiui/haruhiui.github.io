...
上面的编译结果可以说明要支持三种初始化方法要写的函数。那么对于等号直接赋值的方式，它是不是真的先创建了一个对象，然后调用拷贝构造呢？可以看下面。
...
https://blog.csdn.net/qq_36391075/article/details/109358925

https://www.zhihu.com/question/389188159
